...
autenticacao.post("/", async (request, response) => {
  // Utilizamos uma funcão assincrona com async e o await para os metodos que nao devem ser passados para frente enquanto não terminar a execução
  ...
  try {
    ...
    return response
      .status(400)
      .send({ Error: "Erro na autenticação, tente novamente!" });
  }
});
